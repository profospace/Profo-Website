          ...
          {features.map((feature, index) => (
            ...
            >
              <motion.div 
                ...
                className="mx-auto flex items-center text-[#fff] justify-center h-16 w-16 rounded-full bg-[crimson] mb-6"
              >
                {feature.icon}
              </motion.div>
...
//             variants={titleVariants}
//           >
//             <span className="inline-block px-6 py-2 rounded-full bg-gradient-to-r from-indigo-50 to-blue-50 shadow-lg mb-4 text-black text-sm font-medium">
//               PROFO Space Features
//             </span>
//           </motion.div>

//           <motion.h2
//             className="text-5xl font-bold bg-clip-text text-black mb-2"
//             variants={titleVariants}
//           >
//             Why Choose PROFO Space
//           </motion.h2>
...
//           <motion.p
//             className="text-md text-gray-800 max-w-2xl mx-auto"
//             variants={itemVariants}
//           >
//             Revolutionizing real estate with our interactive map-based platform that connects you to properties exactly where you need them.
//           </motion.p>
