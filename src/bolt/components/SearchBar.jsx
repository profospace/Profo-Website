...
// import { Search, MapPin, Home as HomeIcon, DollarSign, Calendar, Users } from 'lucide-react';
...
//               <select className="pl-10 w-full rounded-lg border border-gray-300 py-3 focus:ring-emerald-500 focus:border-emerald-500 appearance-none bg-none">
...
//               <select className="pl-10 w-full rounded-lg border border-gray-300 py-3 focus:ring-emerald-500 focus:border-emerald-500 appearance-none">
...
// import { motion } from 'framer-motion';
// import { Search, MapPin, Home as HomeIcon, DollarSign, Calendar, Users, ArrowUpRight } from 'lucide-react';
...
//       try {
//         // Fix: Don't mix 'geocode' with other types - use '(cities)' option instead
//         const response = await autocompleteService.current?.getPlacePredictions({
//           input: searchInput,
//           types: ['(cities)','(locality)'], // Only search for cities to avoid API errors
//           componentRestrictions: { country: 'in' }, // Restrict to India as shown in the image
//         });
...
//         // If cities search fails, try with addresses as a fallback
//         try {
...
//   const getSuggestionType = (types: string[]) => {
...
//           <button
//             onClick={() => setActiveTab('sell')}
//             className={`px-6 py-3 text-sm font-medium ${activeTab === 'sell'
//                 ? 'text-emerald-600 border-b-2 border-emerald-600'
//                 : 'text-gray-500 hover:text-gray-700'
//               }`}
//           >
...
//           <button
//             onClick={() => setActiveTab('estimate')}
//             className={`px-6 py-3 text-sm font-medium ${activeTab === 'estimate'
//                 ? 'text-emerald-600 border-b-2 border-emerald-600'
//                 : 'text-gray-500 hover:text-gray-700'
//               }`}
//           >
...
//             {/* Suggestions dropdown - styled to match the image */}
//             {showSuggestions && (
...
//                       onClick={() => handleSuggestionClick(suggestion?.structured_formatting.main_text)}
...
//                     >
//                       <div className="flex items-start" onClick={() => handleSuggestionClick(suggestion.structured_formatting.main_text)}>
//                         <MapPin className="h-5 w-5 text-gray-400 mr-3 mt-0.5 flex-shrink-0" />
//                         <div>
//                           <div className="text-sm font-medium text-gray-800">
//                             {suggestion.structured_formatting.main_text}
